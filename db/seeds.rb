...
Dish.create(name:"Poulet braisé", user_id: 1, description:"Le poulet braisé est une des spécialité africaine qui peut être accompagné avec du riz et une sauce, de l’Atiéké, des bananes plantains frits, ou seul avec une sauce tomate pimentée.
Ce poulet a été mariné pendant quelques heures et cuit aux braises Vous allez adorer.", price_per_portion: 4, country:"Togo")
Dish.create(name:"Paëlla spéciale", user_id: 1, description:"A base de riz et de safran, ce plat aussi savoureux qu'économique se compose d'un mélange de viande et de poissons. Je l'ai cuisiné comme on le fait dans ma région d'origine. Vous verrez c'est délicieux !", price_per_portion: 3.5, country:"Espagne")
Dish.create(name:"Bar wot", user_id: 1, description:"banane, oeuf, riz", price_per_portion: 2, country:"Ethiopie")
Dish.create(name:"Couscous-poelée mexicaine", user_id: 1, description:"Riz, poulet, bannane", price_per_portion: 3, country:"Mexique")
Dish.create(name:"Yassa poulet", user_id: 1, description:"Poulet, riz, épices", price_per_portion: 2, country:"Sénégal")
Dish.create(name:"Salade de crudité", user_id: 1, description:"Carotte, salade, tomate", price_per_portion: 2, country:"France")


Ingredient.create(name:"Oeuf", dish_id: 6)
Ingredient.create(name:"Tomate", dish_id: 6)
Ingredient.create(name:"Citron", dish_id: 6)
Ingredient.create(name:"Sucre", dish_id: 6)
Ingredient.create(name:"Farine", dish_id: 6)
